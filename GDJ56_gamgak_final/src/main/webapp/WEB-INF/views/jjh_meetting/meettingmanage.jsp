...
<jsp:include page="/WEB-INF/views/common/header.jsp"/>
                ...
                <H3 style="font-weight: bolder;">모임 정보 관리하기</H3>
                <div style="margin: auto;">
                    ...
                    <div style="display: flex; flex-direction: column; width: 550px; padding: 10px;">
                        ...
                        <input type="text" style="border: 1px #a89e9f solid; border-radius: 5px; height: 40px; background-color: #c1c0c0;  color: white;" value="치킨먹으러갈사람" readonly/>
                    ...
                    <div style="display: flex; flex-direction: column;  width: 550px; padding: 10px;">
                        <span style=" text-align: center; background-color: #dc3545; color: white; border: 3px #dc3545 solid; border-radius: 10px; padding: 5px;">나이</span>
                            <div>
                                ...
                                <input type="number" style="border: 1px #a89e9f solid; border-radius: 5px; height: 40px; background-color: #c1c0c0;  color: white;" value="25" readonly/>
                                <span class="col-6">
                                    최대
                                </span>
                                <input type="number" style="border: 1px #a89e9f solid; border-radius: 5px; height: 40px; background-color: #c1c0c0;  color: white;" value="35" readonly/>
                            </div>
                    ...
                    <div style="display: flex; flex-direction: column;  width: 550px; padding: 10px;">
                        ...
                        <input type="number" style="border: 1px #a89e9f solid; border-radius: 5px; height: 40px; background-color: #c1c0c0;  color: white;" value="6" readonly/>
                    ...
                    <div style="display: flex; flex-direction: column;  width: 550px; padding: 10px;">
                        ...
                        <select style="border: 1px #a89e9f solid; border-radius: 5px; height: 40px; background-color: #c1c0c0;  color: white;" value="4" readonly>
                    ...
                    <div style="display: flex; flex-direction: column;  width: 550px; padding: 10px;">
                        ...
                        <input type="text" placeholder="모임 상세 위치를 입력해주세요" style="border: 1px #a89e9f solid; border-radius: 5px; height: 40px; background-color: #c1c0c0;  color: white;" value="서울시에 있는 어디있는 치킨집" readonly/>
                    ...
                    <div style="display: flex; justify-content: space-between; margin: 10px;" >
                        <button onclick="location.assign('${path}/meetting/invitemeetting.do')" style="text-align: center; background-color: #dc3545; color: white; border: 3px #dc3545 solid; border-radius: 10px; padding: 5px;">
                            참여신청내역
                        </button>
                        <button onclick="location.assign('${path}/meetting/updatemeetting.do')" style="text-align: center; background-color: #dc3545; color: white; border: 3px #dc3545 solid; border-radius: 10px; padding: 5px;">
                            수정하기
                        </button>
