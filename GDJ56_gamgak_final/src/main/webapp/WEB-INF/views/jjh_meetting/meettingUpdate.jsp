...
<jsp:include page="/WEB-INF/views/common/header.jsp"/>
                ...
                <H3 style="font-weight: bolder;">모임 수정하기</H3>
                <div style="margin: auto;">
                	<form action="${path}/meetting/updatemeetingEnd.do" id="subheader-wrapper" method="post" style="padding: 10px;" onsubmit="return enrollmeetting_check();" enctype="multipart/form-data">
                	<input type="hidden" name="memberLeaderNo" value="${loginMember.memberNo}" >
                        <div style="display: flex; flex-direction: column; width: 550px; padding: 10px;">
                            ...
                            <input value="${updateList.meetingTitle }" name="meetingTitle" id="meettingTitle" type="text" style="border: 1px #a89e9f solid; border-radius: 5px; height: 40px;" placeholder="제목을 입력해주세요" />
                            <div class="check_font" id="title_check"></div>
                            <input type="hidden" name="meetingNo" value="${updateList.meetingNo }">
                            ...
                            <span style=" text-align: center; background-color: #dc3545; color: white; border: 3px #dc3545 solid; border-radius: 10px; padding: 5px;">모임 나이</span>
                                <div style="display: flex; justify-content: space-around;">
                                    <div >
                                        ...
                                        <input value="${updateList.meetingMinAge}"  name="meetingMinAge" id="minAge" type="number" style="border: 1px #a89e9f solid; border-radius: 5px; height: 40px; width: 100px;" placeholder="최소" />
                                          <div class="check_font" id="minAge_check" ></div>
                                    </div>
                                    <div>
                                        <span class="col-6">최대</span>
                                        <input value="${updateList.meetingMaxAge}" name="meetingMaxAge" id="maxAge" type="number" style="border: 1px #a89e9f solid; border-radius: 5px; height: 40px; width: 100px;" placeholder="최대" />
                		...
                		<div style="display: flex; flex-direction: column;  width: 550px; padding: 10px;">
                            ...
                            <div style="display: flex; justify-content: space-around;">
                                <input value="${updateList.meetingDate }" name="meetingDate" id="meetingDate" type="datetime-local" style="border: 1px #a89e9f solid; border-radius: 5px; height: 40px; margin: auto;" />
                                <div style="margin: auto;">
                		...
                		<div style="display: flex; flex-direction: column;  width: 550px; padding: 10px;">
                            ...
                            <input value="${updateList.meetingPeopleNum }" id="peopleNum" name="meetingPeopleNum" type="number" style="border: 1px #a89e9f solid; border-radius: 5px; height: 40px;" placeholder="인원수"/>
                        ...
                        <div style="display: flex; flex-direction: column;  width: 550px; padding: 10px;">
                            ...
                            $("#meetingArea").val("${updateList.meetingArea}");
                            $("input:radio[name='meetingGender']:radio[value='${updateList.meetingGender}']").prop('checked', true);
                            var meetingDate=$("#meetingDate").val();
                            console.log("me"+meetingDate);
                            if($("#meetingDate").val()==""){
                            	$("input:checkbox[name='dateCKbox']").prop("checked", true);
                            }else{
                            	$("#meetingDate").val("${updateList.meetingDate}");
                            }
                		...
                		<div style="display: flex; flex-direction: column;  width: 550px; padding: 10px;">
                            ...
                            <input value="${updateList.meetingDetailAddr}" name="meetingDetailAddr" type="text" placeholder="모임 상세 위치를 입력해주세요" style="border: 1px #a89e9f solid; border-radius: 5px; height: 40px;"/>
                       ...
                       <!--  <input type="file" name="fileupload"> -->
                        <div class="filebox preview-image" >
                        	<!-- <input type="file" name="meetingOriname"> -->
                             ...
                             <input value="${updateList.meetingOriname}" name="fileup1" class="upload-name" placeholder="채팅방 썸네일 사진" disabled="disabled" style="width: 300px;">
                        ...
                        <div style="display: flex; justify-content: space-between; margin: 10px;" >
                            <input type="submit" style="text-align: center; background-color: #dc3545; color: white; border: 3px #dc3545 solid; border-radius: 10px; padding: 5px;" value="수정하기">
